...
#             plt.close()
#
#             return render(request, 'index.html', {'hourly_earnings': hourly_earnings, 'price_chart_image': image_filename})
#
#         except ElectricityPrice.DoesNotExist:
#             return render(request, 'index.html', {'error_message': 'Nėra įrašų šiai dienai'})
#
...
#             plt.ylabel("Uždarbis")
#             plt.tight_layout()
#             # grafika issaugau i media folderi
...
#             plt.close()
#
#             # Užkoduokite vaizdo reprezentaciją į Base64
#             # with open(image_path, 'rb') as img_file:
#             #     image_data = img_file.read()
#             # os.remove(image_path)
#             # base64_image = base64.b64encode(image_data).decode('utf-8')
#             # Gauti vaizdo reprezentaciją
#             # image = get_image_from_plot(plt)
#             return FileResponse(open(image_path, 'rb'), content_type='image/png')
#
#             # return render(request, 'index.html', {'hourly_earnings': hourly_earnings, 'price_chart_image': base64_image})
#             # return render(request, 'index.html', {'hourly_earnings': hourly_earnings, 'price_chart_image': image})
